...
const rootElement = flow.dom(flow.h('html', { style: rootStyle, attrs: { 'x-dropflow-log': 'true' } }, [
    flow.h('div', {
        style: image1Style,
        attrs: { id: 'image1' }
    }),
...
// Paint image 1
const [image1El] = rootElement.query('#image1').boxes;
ctx.drawImage(image1, Math.round(image1El.contentArea.x), Math.round(image1El.contentArea.y));
// Paint image 2
const [image2El] = rootElement.query('#image2').boxes;
ctx.drawImage(image2, Math.round(image2El.contentArea.x), Math.round(image2El.contentArea.y));
