import { Selector } from './style-selector.js';
...
type Query<ElementNode> = string | CompiledQuery<ElementNode> | Selector[][];
export declare const query: <Node_1, ElementNode extends Node_1>(query: Query<ElementNode>, elements: Node_1 | Node_1[], options?: Options<Node_1, ElementNode> | undefined) => ElementNode | null;
export declare const queryAll: <Node_1, ElementNode extends Node_1>(query: Query<ElementNode>, elements: Node_1 | Node_1[], options?: Options<Node_1, ElementNode> | undefined) => ElementNode[];
export {};
