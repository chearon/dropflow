...
#line 20 "src/emoji-scan.rl"



#line 89 "src/emoji-scan.rl"


typedef char* emoji_text_iter_t;
typedef int bool;
enum {false = 0, true = 1};

#include <stdint.h>

__attribute__((export_name("emoji_scan")))
emoji_text_iter_t
emoji_scan (emoji_text_iter_t p,
...
#line 1 "NONE"
	...
	break;
	case 3:
#line 85 "src/emoji-scan.rl"
	{act = 2;}
	break;
	case 4:
#line 86 "src/emoji-scan.rl"
	{act = 3;}
	break;
	case 5:
#line 84 "src/emoji-scan.rl"
